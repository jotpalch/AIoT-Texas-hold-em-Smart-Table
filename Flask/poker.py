...
class MonteCarlo:
    ...
    def Run(self, my_hands, op_hands, current_table_cards, PlayerAmount, maxRuns=100000, maxSecs=10) -> None:
...
if __name__ == '__main__':
    ...
    Simulation.Run(my_hands, op_hands, current_table_cards, PlayerAmount, 100, 20)
